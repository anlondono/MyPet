...
namespace MyPet.Common.Services
{
    public class ApiService : IApiService
    {
        ...
        public async Task<Response<TemporaryOwnerResponse>> GetOwnerByEmailAsync(
            string urlBase,
            string servicePrefix,
            string controller,
            string tokenType,
            ...
            string email)
        {
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    return new Response<TemporaryOwnerResponse>
                    {
                        IsSuccess = false,
                        Message = result,
                    };
                ...
                var owner = JsonConvert.DeserializeObject<TemporaryOwnerResponse>(result);
                return new Response<TemporaryOwnerResponse>
                {
                    IsSuccess = true,
                    Result = owner
